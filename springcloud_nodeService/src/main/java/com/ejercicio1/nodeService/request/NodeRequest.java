...
public class NodeRequest {
    ...
    public NodeRequest(String id, String name, String description) {
        this.name = name;
        this.description = description;
    }

    public NodeDesc toNodeDescModel(){
        return NodeDesc.nodeDescBuilder().id(this.id).name(this.name).description(this.description).build();
    }
